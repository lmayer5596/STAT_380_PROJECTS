...
train <- all_data[grep('^train', Id)][, .(LotArea, GrLivArea, PoolArea, TotalBsmtSF, SalePrice)]
#selects the rows which are labelled as test
test <- all_data[grep('^test', Id)][, .(Id, LotArea, GrLivArea, PoolArea, TotalBsmtSF, SalePrice)]
